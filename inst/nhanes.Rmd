...
TAB2a_ATE2 <- tbl_regression(fit2_a_ate, TAB2_LABS2_ATE, exponentiate = T) |>
...
des_pssvywtdlm2 <- svydesign(ids = ~ SDMVPSU, strata = ~ SDMVSTRA, nest = T,
                        
  weights = ~ comb_wt2, data = NHANES3)
...
des_wtdpssvywtdlm2 <- svydesign(ids = ~ SDMVPSU, strata = ~ SDMVSTRA, nest = T,
                        
  weights = ~ wtd_comb_wt2, data = NHANES3)
