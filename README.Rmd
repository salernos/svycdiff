...
This packages also contains the code necessary to reproduce the motivation data analysis in *"What's the weight? Estimating controlled outcome differences in complex surveys for health disparities research."* This analysis focuses on data from the National Health and Nutrition Examination Survey (NHANES), investigating the interplay of race and social determinants of health when our interest lies in estimating racial differences in mean telomere length.
...
For questions and comments, please contact Stephen Salerno (<ssalerno@fredhutch.org>).
